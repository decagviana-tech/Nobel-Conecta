      ...
      <div className="bg-black rounded-[2.5rem] p-8 mb-8 text-white relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10">
          ...
          <div className="mt-4 max-w-sm rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-[10px] font-bold leading-relaxed text-gray-300">
            <p>
              <span className="text-yellow-400 uppercase tracking-widest">Limite mensal:</span> cada leitor pode resgatar 1 prêmio físico por mês. Cupons de desconto continuam liberados.
            </p>
            <p className="mt-2">
